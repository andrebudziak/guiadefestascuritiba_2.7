<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administracao/Site.master" CodeFile="cadastro_categoria_tema.aspx.cs" Inherits="Administracao_cadastro_categoria_tema" %>
                   ...
                   <td align="center">
                       <asp:Panel ID="Panel1" runat="server" Width="1024px" BackColor="White">
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                               ...
                               <tr>
                                   <td align="right">
                                       <asp:Label ID="Label14" runat="server" CssClass="label" Text="Tema:"></asp:Label>
                                   </td>
                                   <td align="left">
                               ...
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                           DeleteMethod="ExcluirCategoriaTema" InsertMethod="IncluiCategoriaTema" 
                                           SelectMethod="ConsultaTemaCategoria" TypeName="WebService" 
                                           UpdateMethod="IncluiCategoriaTema" ondeleting="ObjectDataSource1_Deleting" 
                                       ...
                                       <UpdateParameters>
                                           ...
                                           <asp:Parameter Name="codigo_tema" Type="Int32" />
                                       </UpdateParameters>
                                       <SelectParameters>
                                           ...
                                           <Columns>     
                                              <asp:TemplateField ShowHeader="False">
                                                ...
                                                <asp:TemplateField HeaderText="Categoria">
                                                   <ItemTemplate>
                                                      <asp:Label ID="lblCodigoCategoria" Visible="false" runat="server" Text='<%# Bind("codigo_tema") %>' />
                                                      <asp:Label ID="lblCategoria" runat="server" Text='<%# Bind("tema") %>' />
                                                   </ItemTemplate>
                                               </asp:TemplateField>                                  
