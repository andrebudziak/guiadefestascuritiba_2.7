...
public partial class Administracao_cadastro_destaque : System.Web.UI.Page
{
    ...
    protected void grdDados_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Select")
        {
            ...
            CKEditor1.Text = ((Label)grdDados.Rows[row.RowIndex].FindControl("lblDescricao")).Text;
            ddlStatus.SelectedValue = ((DropDownList)grdDados.Rows[row.RowIndex].FindControl("ddlStatus")).SelectedValue;
            ddlTipoDestaque.SelectedValue = ((DropDownList)grdDados.Rows[row.RowIndex].FindControl("ddlTipoDestaque")).SelectedValue;
    ...
    protected void ObjectDataSource1_Inserting(object sender, ObjectDataSourceMethodEventArgs e)
    {
        ...
        e.InputParameters["destaque"] = CKEditor1.Text;
        e.InputParameters["status"] = ddlStatus.SelectedValue;
        e.InputParameters["tipo_destaque"] = ddlTipoDestaque.SelectedValue;
    ...
    protected void ObjectDataSource1_Selecting(object sender, ObjectDataSourceSelectingEventArgs e)
    {
        e.InputParameters["codigo"] = "0";
        if (txtPesquisa.Text == "")
            e.InputParameters["texto"] = "0";
        else
            e.InputParameters["texto"] = txtPesquisa.Text;
        e.InputParameters["tipo_destaque"] = ddlTipoDestaque.SelectedValue;
    }
