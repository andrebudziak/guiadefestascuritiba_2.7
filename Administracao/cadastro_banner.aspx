<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administracao/Site.master" CodeFile="cadastro_banner.aspx.cs" Inherits="Administracao_cadastro_banner" %>
                   ...
                   <td align="center">
                       <asp:Panel ID="Panel1" runat="server" Width="1024px" BackColor="White">
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                               ...
                               <tr>
                                   <td align="right">
                                       <asp:Label ID="Label18" runat="server" CssClass="label" Text="Miniatura:"></asp:Label>
                                   </td>
                                   <td align="left">
                                       <asp:TextBox ID="txtMiniatura" runat="server" CssClass="edit" Width="200px"></asp:TextBox>
                                   </td>
                                   <td>
                                       &nbsp;</td>
                               </tr>
                               ...
                               <tr>
                                   <td align="right">
                                       <asp:Label ID="Label10" runat="server" CssClass="label" Text="Local Banner:"></asp:Label>
                                   </td>
                                   <td align="left">
                                        <asp:DropDownList ID="ddlLocalBanner" runat="server" 
                                            DataTextField="descricao" DataValueField="codigo" 
                                            DataSourceID="ObjectDataSource3" CssClass="edit" Width="200px">
                                        </asp:DropDownList>
                               ...
                               <tr>
                                   <td align="right">
                                       <asp:Label ID="Label11" runat="server" CssClass="label" Text="Largura:"></asp:Label>
                                   </td>
                                   <td align="left">
                                      
                                       <asp:TextBox ID="txtLargura" runat="server" CssClass="edit" Width="50px"></asp:TextBox>
                                   </td>
                                   <td>
                                       &nbsp;</td>
                               </tr>
                               <tr>
                                   <td align="right">
                                       <asp:Label ID="Label12" runat="server" CssClass="label" Text="Altura:"></asp:Label>
                                   </td>
                                   <td align="left">
                                       <asp:TextBox ID="txtAltura" runat="server" CssClass="edit" Width="50px"></asp:TextBox>
                                   </td>
                                   <td>
                                       &nbsp;</td>
                               </tr>
                               ...
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                           DeleteMethod="ExcluirBanner" InsertMethod="IncluirBanner" 
                                           SelectMethod="ConsultaBanner" TypeName="WebService" 
                                           UpdateMethod="IncluirBanner" ondeleting="ObjectDataSource1_Deleting" 
                                       ...
                                       <UpdateParameters>
                                           ...
                                           <asp:Parameter Name="codigo_local_banner" Type="Int32" />
                                   ...
                                   <td align="center" colspan="3">
                                       <asp:GridView ID="grdDados" runat="server" AutoGenerateColumns="False" 
                                           ...
                                           <asp:TemplateField HeaderText="Local">
                                               <ItemTemplate>
                                                   <asp:DropDownList ID="ddlLocalBanner" runat="server" Enabled="false" 
                                           ...
                                           <asp:TemplateField HeaderText="Status">
                                              <ItemTemplate>
                                                 <asp:DropDownList ID="ddlStatus" Width="65px" runat="server" SelectedValue='<%# Bind("codigo_status")%>' Enabled="false" >
