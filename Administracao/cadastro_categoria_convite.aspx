<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administracao/Site.master" CodeFile="cadastro_categoria_convite.aspx.cs" Inherits="Administracao_cadastro_categoria_convite" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
                   ...
                   <td align="center">
                       <asp:Panel ID="Panel1" runat="server" Width="1024px" BackColor="White">
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                               ...
                               <tr>
                                   <td align="right">
                                       <asp:Label ID="Label14" runat="server" CssClass="label" Text="Anuncio:"></asp:Label>
                                   </td>
                                   <td align="left">
                                       <asp:DropDownList ID="ddlAnuncio" runat="server" 
                                           DataTextField="convite" 
                                           DataValueField="codigo" Width="200px" AutoPostBack="True">
                                       </asp:DropDownList>
                                   </td>
                                   <td>
                               ...
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                           DeleteMethod="ExcluirCategoriaConvite" InsertMethod="IncluiCategoriaConvite" 
                                           SelectMethod="ConsultaConviteCategoria" TypeName="WebService" 
                                           UpdateMethod="IncluiCategoriaConvite" ondeleting="ObjectDataSource1_Deleting" 
                                       ...
                                       <UpdateParameters>
                                           ...
                                           <asp:Parameter Name="codigo_convite" Type="Int32" />
                                       </UpdateParameters>
                                       <SelectParameters>
                                           ...
                                           <Columns>     
                                              <asp:TemplateField ShowHeader="False">
                                                ...
                                                <asp:TemplateField HeaderText="Anunciante">
                                                   <ItemTemplate>
                                                      <asp:Label ID="lblCodigoAnuncio" Visible="false" runat="server" Text='<%# Bind("codigo_cliente") %>' />
                                                      <asp:Label ID="lblAnuncio" runat="server" Text='<%# Bind("anunciante") %>' />
                                                   </ItemTemplate>
                                               </asp:TemplateField>                                  
                                                <asp:TemplateField HeaderText="Categoria">
                                                   <ItemTemplate>
                                                      <asp:Label ID="lblCodigoCategoria" Visible="false" runat="server" Text='<%# Bind("codigo_convite") %>' />
                                                      <asp:Label ID="lblCategoria" runat="server" Text='<%# Bind("convite") %>' />
                                                   </ItemTemplate>
                                               </asp:TemplateField>                                  
    ...
    <asp:UpdateProgress ID="UpdateProgress1" runat="server" 
        ...
        <ProgressTemplate>
            <img alt="" src="mytnr/wait.gif" class="style1" />Aguarde...</ProgressTemplate>
    </asp:UpdateProgress>
