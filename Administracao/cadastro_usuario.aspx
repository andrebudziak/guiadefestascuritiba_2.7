<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administracao/Site.master" CodeFile="cadastro_usuario.aspx.cs" Inherits="Administracao_cadastro_usuario" %>
                   ...
                   <td align="center">
                       <asp:Panel ID="Panel1" runat="server" Width="1024px" BackColor="White">
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                               ...
                               <tr>
                                   <td align="right">
                                       <asp:Label ID="Label14" runat="server" CssClass="label" Text="Senha:"></asp:Label>
                                   </td>
                                   <td align="left">
                                       <asp:TextBox ID="txtSenha" runat="server" CssClass="edit" TextMode="Password" 
                               ...
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                           ...
                                           UpdateMethod="IncluirUsuario" ondeleting="ObjectDataSource1_Deleting" 
                                       ...
                                       <asp:GridView ID="grdDados" runat="server" AutoGenerateColumns="False" 
                                           ...
                                           <Columns>     
                                              <asp:TemplateField ShowHeader="False">
                                               ...
                                               <asp:TemplateField HeaderText="Usuario" SortExpression="descricao">
                                                   <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Senha" SortExpression="senha">
                                                   <ItemTemplate>
                                                      <asp:TextBox ID="txtSenha" Enabled="false" TextMode="Password" runat="server" Width="100px" Text='<%# Bind("senha") %>' />
                                                   </ItemTemplate>
                                                </asp:TemplateField>                                            
