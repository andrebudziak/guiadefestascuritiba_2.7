...
public partial class Administracao_cadastro_link : System.Web.UI.Page
{
    ...
    protected void grdDados_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Select")
        {
            ...
            txtOrkut.Text = ((Label)grdDados.Rows[row.RowIndex].FindControl("lblOrkut")).Text;
            txtFacebook.Text = ((Label)grdDados.Rows[row.RowIndex].FindControl("lblFacebook")).Text;
            txtTwitter.Text = ((Label)grdDados.Rows[row.RowIndex].FindControl("lblTwitter")).Text;
    ...
    protected void ObjectDataSource1_Inserting(object sender, ObjectDataSourceMethodEventArgs e)
    {
        ...
        e.InputParameters["orkut"] = txtOrkut.Text;
        e.InputParameters["facebook"] = txtFacebook.Text;
        e.InputParameters["twitter"] = txtTwitter.Text;
