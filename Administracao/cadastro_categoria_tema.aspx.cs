...
public partial class Administracao_cadastro_categoria_tema : System.Web.UI.Page
{
    ...
    protected void ObjectDataSource1_Inserting(object sender, ObjectDataSourceMethodEventArgs e)
    {
        ...
        e.InputParameters["codigo_tema"] = ddlAnuncio.SelectedValue;
    ...
    {
        DataSet data = ws.ConsultaCategoriaTipo("tipo_categoria=9 order by descricao");
    ...
    {
        DataSet data = ws.ConsultaTemaCampoComposto(0);
        //criar um objeto Data Row
        DataRow oDR = data.Tables[0].NewRow();
