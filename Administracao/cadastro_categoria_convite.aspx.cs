...
public partial class Administracao_cadastro_categoria_convite : System.Web.UI.Page
{
    ...
    protected void ObjectDataSource1_Inserting(object sender, ObjectDataSourceMethodEventArgs e)
    {
        ...
        e.InputParameters["codigo_convite"] = ddlAnuncio.SelectedValue;
    ...
    {
        DataSet data = ws.ConsultaCategoriaTipo("tipo_categoria=7 or tipo_categoria=8");
    ...
    {
        DataSet data = ws.ConsultaConviteCampoComposto(0);
        //criar um objeto Data Row
        DataRow oDR = data.Tables[0].NewRow();

        //Preencher o datarow com valores
        oDR["convite"] = "[Selecione]";
        oDR["codigo"] = "0";
