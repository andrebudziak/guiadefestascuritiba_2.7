<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administracao/Site.master" CodeFile="cadastro_sinonimo.aspx.cs" Inherits="Administracao_cadastro_sinonimo" %>
                               ...
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                           DeleteMethod="ExcluirSinonimo" InsertMethod="IncluirSinonimo" 
                                           SelectMethod="ConsultaSinonimo" TypeName="WebService" 
                                           UpdateMethod="IncluirSinonimo" ondeleting="ObjectDataSource1_Deleting" 
                                       ...
                                       <UpdateParameters>
                                           <asp:Parameter Name="codigo" Type="Int32" />
                                           <asp:Parameter Name="sinonimo" Type="String" />
                                       </UpdateParameters>
                                       <SelectParameters>
                                           <asp:Parameter DefaultValue="0" Name="codigo" Type="Int32" />
                                           <asp:Parameter DefaultValue="0" Name="sinonimo" Type="String" />
                                       </SelectParameters>
                                       <InsertParameters>
                                           <asp:Parameter Name="codigo" Type="Int32" />
                                           <asp:Parameter Name="sinonimo" Type="String" />
                                       ...
                                       <asp:GridView ID="grdDados" runat="server" AutoGenerateColumns="False" 
                                           ...
                                           <Columns>     
                                              <asp:TemplateField ShowHeader="False">
                                               ...
                                               <asp:TemplateField HeaderText="Sinonimo" SortExpression="sinonimo">
                                                   <ItemTemplate>
                                                      <asp:Label ID="lblDescricao" runat="server" Text='<%# Eval("sinonimo") %>' />
                                                   </ItemTemplate>
                                                </asp:TemplateField>               
