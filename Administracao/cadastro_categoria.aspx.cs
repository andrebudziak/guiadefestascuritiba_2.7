...
public partial class Administracao_cadastro_categoria : System.Web.UI.Page
{
    ...
    protected void grdDados_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Select")
        {
            ...
            ddlTipoCategoria.SelectedValue = ((DropDownList)grdDados.Rows[row.RowIndex].FindControl("ddlTipoCategoria")).SelectedValue;
    ...
    protected void ObjectDataSource1_Inserting(object sender, ObjectDataSourceMethodEventArgs e)
    {
        ...
        e.InputParameters["tipocategoria"] = ddlTipoCategoria.SelectedValue;
        e.InputParameters["observacao"] = "";
