<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administracao/Site.master" CodeFile="cadastro_categoria_anuncio.aspx.cs" Inherits="Administracao_cadastro_categoria_anuncio" %>
                               ...
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                                           DeleteMethod="DeleteCategoriaAnunciante" InsertMethod="IncluiCategoriaAnunciante" 
                                           ...
                                           <Columns>     
                                              <asp:TemplateField ShowHeader="False">
                                                ...
                                                <asp:TemplateField HeaderText="Anunciante">
                                                   <ItemTemplate>
                                                      <asp:Label ID="lblCodigoAnuncio" Visible="false" runat="server" Text='<%# Bind("codigo_anunciante") %>' />
