...
namespace eChat
{
	public class ChatRoom : IDisposable
	{
        ...
        public void UpdateAnunciante(string userID, int anuncianteId)
        {
           ChatUser user = this.GetUser(userID);
           if (user == null)
              return;
           user.AnuncianteId = anuncianteId;
        
        }

        public void DeleteChat(int anuncianteId)
        {
            WebService ws = new WebService();
            ws.DeleteChat(anuncianteId);        
        }
        ...
        public string SendMessage(string strMsg, string senderID, string msgFrom)
        {
